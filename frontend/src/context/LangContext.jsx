...
export const T = {
  ...
  registerTitle:       { hi: 'Smart Sakhi se judeye', en: 'Join Smart Sakhi' },
  registerSubtitle:    { hi: 'Account banao aur beauty booking shuru karo', en: 'Create your account to book beauty services' },
  registerNamePlaceholder: { hi: 'Aapka poora naam', en: 'Your full name' },
  registerPhonePlaceholder: { hi: '10-digit mobile', en: '10-digit mobile' },
  registerEmailPlaceholder: { hi: 'aapka@email.com', en: 'your@email.com' },
  registerPasswordPlaceholder: { hi: 'Kam se kam 6 ank', en: 'Minimum 6 characters' },
  registerAddressPlaceholder: { hi: 'Mohalla / Colony', en: 'Mohalla / Colony' },
  registerCityLabel:   { hi: 'Sheher', en: 'City' },
  registerPhoneLabel:  { hi: 'Phone Number *', en: 'Phone Number *' },
  registerEmailLabel:  { hi: 'Email (optional)', en: 'Email (optional)' },
  registerPasswordLabel: { hi: 'Password *', en: 'Password *' },
  registerAddressLabel: { hi: 'Address', en: 'Address' },
  registerCreateButton: { hi: 'Account banaye →', en: 'Create Account →' },
  registerAlreadyHave: { hi: 'Kya pehle se account hai?', en: 'Already have an account?' },
  registerBackHome:    { hi: '← Home par wapas', en: '← Back to Home' },
  registerValidationRequired: { hi: 'Name, phone aur password zaroori hai', en: 'Name, phone and password are required' },
  registerPasswordLength: { hi: 'Password kam se kam 6 characters ka hona chahiye', en: 'Password must be at least 6 characters' },
  registerSuccess:     { hi: 'Smart Sakhi mein swagat hai!', en: 'Welcome to Smart Sakhi! 💄' },
  registerFailure:     { hi: 'Registration mein kuch galat ho gaya. Dobara koshish karo.', en: 'Registration failed. Please try again.' },
  registerPhoneExists: { hi: 'Phone number pehle se register hai', en: 'Phone number already registered' },
  registerCreating:    { hi: 'Account ban raha hai…', en: 'Creating Account…' },
  loginFillFields:      { hi: 'Sabhi fields bhariye', en: 'Please fill all fields' },
  loginSuccess:         { hi: 'Dobara swaagat hai! 💄', en: 'Welcome back! 💄' },
  loginErrorGeneral:    { hi: 'Login mein kuch galat ho gaya. Dobara koshish karo.', en: 'Something went wrong during login. Please try again.' },
  loginErrorNotRegistered: { hi: 'Phone number abhi register nahi hai.', en: 'This phone number is not registered yet.' },
